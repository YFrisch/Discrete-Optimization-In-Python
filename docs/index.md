...
3. {doc}`03 — Affine Mappings and Polar Cones </notebooks/03-Affine-Mappings-and-Polar-Cones>`
4. {doc}`04 — Interior and Exterior Representation </notebooks/04-Interior-Exterior-Representations>`
5. {doc}`05 — The Integer Hull </notebooks/05-The-Integer-Hull>`
6. {doc}`06 — Branch and Bound Method </notebooks/06-Branch-And-Bound>`
7. {doc}`07 — Unimodularity and Dual Integrality </notebooks/07-Unimodularity-and-Total-Dual-Integrality>`
8. {doc}`08 — Gomory Cuts </notebooks/08-Fractional-and-Mixed-Integer-Gomory-Cuts>`
9. {doc}`09 — The Knapsack Problem </notebooks/09-The-Knapsack-Problem>`
10. {doc}`10 — The Set-Packing Polytope </notebooks/10-The-Set-Packing-Polytope>`
11. {doc}`11 — Lagrange Relaxation </notebooks/11-Lagrange-Relaxation>`
12. {doc}`12 — Dantzig-Wolfe Decomposition </notebooks/12-Dantzig-Wolfe-Decomposition>`
13. {doc}`13 — Bender's Decomposition </notebooks/13-Benders-Decomposition>`
14. {doc}`14 — Heuristics </notebooks/14-Heuristic-Methods>`
15. {doc}`15 — Other Heuristics </notebooks/15-Other-Heuristics>`
